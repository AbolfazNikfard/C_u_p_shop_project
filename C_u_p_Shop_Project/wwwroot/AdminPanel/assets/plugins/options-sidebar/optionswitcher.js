        ...
        <div class="right-sidebar-container-2">
          <div class="slim-scroll-right-sidebar-2">
            ...
            <div class="right-sidebar-2-body" data-simplebar>
              <span class="right-sidebar-2-subtitle">طرح هدر</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-fixed-to btn-right-sidebar-2-active">ثابت</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-static-to">استاتیک</a>
              </div>

              <span class="right-sidebar-2-subtitle">طرح نوار کناری</span>
              <div class="no-col-space">
                <select class="right-sidebar-2-select" id="sidebar-option-select">
                  <option value="ec-sidebar-fixed">پیش فرض ثابت</option>
                  <option value="ec-sidebar-fixed-minified">ثابت شده</option>
                  <option value="ec-sidebar-fixed-offcanvas">آفکنوس ثابت</option>
                  <option value="ec-sidebar-static">پیش فرض استاتیک</option>
                  <option value="ec-sidebar-static-minified">استاتیک کوچک شده</option>
                  <option value="ec-sidebar-static-offcanvas">استاتیک آفکنوس</option>
                </select>
              </div>

              <span class="right-sidebar-2-subtitle">پس زمینه سربرگ</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active ec-header-light-to"> روشن </a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-dark-to">تیره</a>
              </div>

              <span class="right-sidebar-2-subtitle">پیش زمینه ناوبری</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active ec-sidebar-light-to"> روشن </a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-sidebar-dark-to">تیره</a>
              </div>

              <span class="right-sidebar-2-subtitle">طرح فاصله</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active default-spacing-to">پیش فرض</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 compact-spacing-to">کوچک</a>
              </div>
              <div class="d-flex justify-content-center">
                <div id="reset-options" style="width: auto; cursor: pointer" class="btn-right-sidebar-2 btn-reset"> تنظیم مجدد</div>
              </div>
            </div>
          </div>
        </div>
