...
sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"داده ای در جدول وجود ندارد",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ داده",sInfoEmpty:"نمایش 0 تا 0 از 0 داده",sInfoFiltered:"(فیلتر ار _MAX_ کل داده)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ داده",sLoadingRecords:"بارگذاری...",sProcessing:"در حال پردازش...",sSearch:"جستجو کردن:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"هیچ پرونده تطبیقی یافت نشد"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
