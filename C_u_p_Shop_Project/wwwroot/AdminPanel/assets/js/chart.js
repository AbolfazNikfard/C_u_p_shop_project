...
$(document).ready(function() {
  ...
  if (dual !== null) {
    var urChart = new Chart(dual, {
      type: "line",
      data: {
        labels: ["جمعه", "شنبه", "یک شنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه"],
        datasets: [
          {
            label: "قدیمی",
            pointRadius: 4,
          ...
          yAxes: [
            {
              ...
              ticks: {
                callback: function(value) {
                  var ranges = [
                    { divider: 1e6, suffix: "م" },
                    { divider: 1e4, suffix: "ک" }
                  ];
        ...
        tooltips: {
          callbacks: {
            ...
            label: function(tooltipItem, data) {
              return data["datasets"][0]["data"][tooltipItem["index"]] + "تومان" ;
            }
          },
          responsive: true,
          intersect: false,
  ...
  if (doughnut !== null) {
    var myDoughnutChart = new Chart(doughnut, {
      type: "doughnut",
      data: {
        labels: ["کامل", "بدون پرداخت", "انتظار", "لغو ", "برگشته", "شکسته "],
        datasets: [
          {
            label: ["کامل", "بدون پرداخت", "انتظار", "لغو ", "برگشته", "شکسته "],
  ...
  if (polar !== null) {
    var configPolar = {
      data: {
        ...
        labels: ["کل فروش", "رد شده", "کامل", "در انتظار", "ذخیره"]
      },
      options: {
        responsive: true,
        maintainAspectRatio: false,
 ...
 "فروردین",
  ...
  if (hbar1 !== null) {
    var hbChart1 = new Chart(hbar1, {
      type: "horizontalBar",
      data: {
        labels: ["هندوستان", "ایالات متحده آمریکا", "ترکیه"],
        datasets: [
          {
            label: "ثبت نام",
            data: [18, 13, 9.5],
  ...
  if (hbar2 !== null) {
    var hbChart2 = new Chart(hbar2, {
      type: "horizontalBar",
      data: {
        labels: ["فلوریدا", "لهستان", "انگلستان"],
        datasets: [
          {
            label: "ثبت نام",
            data: [7.5, 4.6, 4],
...
if (acquisition3 !== null) {
  var acChart3 = new Chart(acquisition3, {
    ...
    // The data for our dataset
    data: {
      labels: ["4 فروردین", "5 فروردین", "6 فروردین", "7 فروردین", "8 فروردین", "9 فروردین", "10 فروردین"],
      datasets: [
        {
          label: "معرف",
...
if(typeof elem !== 'undefined' && elem !== null) {
  ...
  var myChart = new Chart(ctx, {
      type: 'horizontalBar',
      data: {
          labels: ["داده 1", "داده 2", "داده 3", "داده 4", "داده 5"],
          datasets: [{
              label: "داده",
...
if(typeof curveeml_ctx !== 'undefined' && curveeml_ctx !== null) {
  ...
  var chart = new Chart(ctx, {
      ...
      // The data for our dataset
      data: {
          labels: ["دی", "آبان", "آذر", "بهمن", "فروردین", "اردیبهشت", "خرداد", "تیر"],
          datasets: [{
              label: "Income",
